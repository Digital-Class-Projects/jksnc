...
export default function StaffNocApplicationsPage() {
    ...
    const fetchApplications = async () => {
        ...
        try {
            ...
            if (!staffSnapshot.exists()) {
                toast({ variant: 'destructive', title: 'Staff Not Found' });
                setIsLoading(false);
                return;
            }
    ...
    <div className="p-4 md:p-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Review NOC applications submitted by students in your assigned branch.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
