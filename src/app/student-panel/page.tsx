            ...
            <div className="flex items-center gap-6">
             ...
             <div className="flex items-center gap-6">
                <Avatar className="h-32 w-32 border-4 border-primary/20">
                    <AvatarImage src={studentData.photoUrl || 'https://picsum.photos/seed/avatar/200'} alt={studentData.studentName} data-ai-hint="student portrait" />
        ...
        <CardContent>
          <Tabs defaultValue="details">
            <TabsList className="flex-wrap h-auto justify-start">
              ...
              <TabsTrigger value="liveclass">Live Classes</TabsTrigger>
            ...
            <TabsContent value="details">
             ...
             <TabsContent value="idcard"><p className="p-4 text-center">ID Card is not available yet.</p></TabsContent>
             <TabsContent value="certificate"><p className="p-4 text-center">Certificate is not available yet.</p></TabsContent>
             <TabsContent value="attendance"><p className="p-4 text-center">Attendance record is not available yet.</p></TabsContent>
             <TabsContent value="marksheet"><p className="p-4 text-center">Marksheet is not available yet.</p></TabsContent>
             <TabsContent value="liveclass"><p className="p-4 text-center">Live class schedule is not available yet.</p></TabsContent>
