      ...
      <main className="flex-1">
        <section className="container mx-auto px-4 py-20 md:py-28">
            <div className="text-center mb-16">
                <h1 className="text-4xl md:text-5xl font-bold text-primary tracking-tight">Our Blog</h1>
                    ...
                    {blogs.map(blog => (
                        <Card key={blog.id} className="flex flex-col overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 group border-border/50">
                            <div className="flex-shrink-0 overflow-hidden">
                                <Image
                                    src={blog.imageUrl || "https://picsum.photos/seed/blog-post/600/400"}
                                    alt={blog.title}
                                    width={600}
                                    height={400}
                            ...
                            <div className="flex flex-1 flex-col justify-between bg-card p-6">
                                <div className="flex-1">
                                    ...
                                    <CardTitle className="mt-2 text-xl font-semibold text-primary group-hover:text-accent transition-colors">
                                ...
                                <div className="mt-6 flex items-center justify-between">
                                    ...
                                    <Link href="#" className="text-sm font-semibold text-accent hover:text-primary transition-colors flex items-center gap-1">
