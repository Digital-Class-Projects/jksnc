...
export default function HomePage() {
  ...
  const [migrationCertPreview, setMigrationCertPreview] = useState<string | null>("https://ik.imagekit.io/rgazxzsxr/Migration%20Certifiate.png?updatedAt=1760612547767");
  ...
  const handleCertImageURLChange = (certId: string) => (e: React.ChangeEvent<HTMLInputElement>) => {
    const { value } = e.target;
    setMigrationCertPreview(value); // Update preview immediately
    setContent(prev => ({
        ...prev,
        certificateDesigns: {
            ...prev.certificateDesigns,
            [certId]: {
                ...(prev.certificateDesigns?.[certId] || { name: 'Migration Certificate', imageUrl: '' }),
                imageUrl: value,
            }
        }
    }));
                     ...
                     <div className="space-y-4 p-4 border rounded-lg">
                        <div className="space-y-2">
                            ...
                            <Input 
                                ...
                                value={content.certificateDesigns?.migration?.name || 'Migration Certificate'} 
