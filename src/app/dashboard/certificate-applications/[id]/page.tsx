...
export default function CertificateApplicationReviewPage() {
  ...
  const applicationPath = `applications/certificates/${studentUid}/${appId}`;
          ...
          <Card>
            ...
            <CardContent>
                 <Card className="mb-6">
                    ...
                    <ApplicationDetail label="Father's Name" value={application.fatherName} />
                    <ApplicationDetail label="Mother's Name" value={application.motherName} />
                    <ApplicationDetail label="Gender" value={application.gender} />
                    <ApplicationDetail label="Date of Birth" value={application.dateOfBirth ? new Date(application.dateOfBirth).toLocaleDateString() : 'N/A'} />
                    <ApplicationDetail label="Contact Number" value={application.contactNumber} />
                    <ApplicationDetail label="Email" value={application.email} />
                ...
                <Card className="mb-6">
                    <CardHeader><CardTitle className="text-xl">Academic Information</CardTitle></CardHeader>
                    <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <ApplicationDetail label="Enrollment Number" value={application.enrollmentNumber} />
                    <ApplicationDetail label="Roll Number" value={application.rollNumber} />
                    <ApplicationDetail label="Course Name" value={application.courseName} />
                    <ApplicationDetail label="Branch Name" value={application.branchName} />
                    <ApplicationDetail label="Academic Session" value={application.academicSession} />
                    <ApplicationDetail label="Completion Date" value={application.completionDate ? new Date(application.completionDate).toLocaleDateString() : 'N/A'} />
                    <ApplicationDetail label="Marks/Percentage" value={application.marksPercentage} />
                    <ApplicationDetail label="State Council Registration No." value={application.registrationNumber} />
                    </CardContent>
                </Card>

                 <Card className="mb-6">
                    <CardHeader><CardTitle className="text-xl">Certificate Details</CardTitle></CardHeader>
                    <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <ApplicationDetail label="Certificate Type" value={application.certificateType} />
                        <ApplicationDetail label="Language" value={application.certificateLanguage} />
                        <div className="md:col-span-2">
                             <ApplicationDetail label="Purpose for Issue" value={application.issuePurpose} />
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="space-y-2 text-center">
                            ...
                            <div className="w-full aspect-square border rounded-md flex items-center justify-center bg-muted overflow-hidden">
                                {application.studentPhoto ? <a href={application.studentPhoto} target="_blank" rel="noopener noreferrer"><Image src={application.studentPhoto} alt="Student" width={150} height={150} className="object-cover" /></a> : 'Not Uploaded'}
                            </div>
                        </div>
                        <div className="space-y-2 text-center">
                            <Label>Marksheet</Label>
                            <div className="w-full aspect-square border rounded-md flex items-center justify-center bg-muted overflow-hidden p-2 text-blue-600 underline">
                                {application.marksheetUpload ? <a href={application.marksheetUpload} target="_blank" rel="noopener noreferrer">View Document</a> : 'Not Uploaded'}
                            </div>
                        </div>
                        <div className="space-y-2 text-center">
                            <Label>ID Proof</Label>
                            <div className="w-full aspect-square border rounded-md flex items-center justify-center bg-muted overflow-hidden p-2 text-blue-600 underline">
                                {application.idProof ? <a href={application.idProof} target="_blank" rel="noopener noreferrer" >View Document</a> : 'Not Uploaded'}
                            </div>
                        </div>
                        <div className="space-y-2 text-center">
                            <Label>Signature</Label>
                            <div className="w-full aspect-square border rounded-md flex items-center justify-center bg-muted overflow-hidden">
                                {application.signatureUpload ? <a href={application.signatureUpload} target="_blank" rel="noopener noreferrer"><Image src={application.signatureUpload} alt="Signature" width={150} height={150} className="object-contain p-2" /></a> : 'Not Uploaded'}
                            </div>
                        </div>
                    </CardContent>
                </Card>
