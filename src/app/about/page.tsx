    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-1">
        <section
          ...
          style={{ backgroundImage: `url(${details?.bannerUrl || 'https://picsum.photos/seed/about-banner/1920/500'})` }}
        >
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
             <div className="space-y-6">
                {loading ? (
                    ...
                    <>
                        <h2 className="text-3xl md:text-4xl font-bold text-primary tracking-tight">{content?.heading || 'Our Story'}</h2>
             ...
             <div>
                {loading ? (
                    ...
                    <Image
                        src={content?.banner || "https://picsum.photos/seed/about-image/600/450"}
                        alt={content?.heading || "About Us Image"}
                        width={600}
                        height={450}
